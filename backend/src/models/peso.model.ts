...
type PesoCreationAttributes = Optional<
  PesoAttributes,
  "id_peso" | "fecha_creacion" | "updatedAt" | "comentario" | "fecha"
>;

// Definición del Modelo
class Peso
  extends Model<PesoAttributes, PesoCreationAttributes>
  implements PesoAttributes
{
